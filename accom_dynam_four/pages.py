...
class WaitingPageNewApp(WaitPage):
    template_name = 'accom_dynam_four/WaitingPageNewApp.html'
...
class WaitingPageTimer(WaitPage):
    template_name = 'accom_dynam_four/WaitingPageTimer.html'
...
class AccomDynamPage(Page):
    ...
    timer_text = 'Time left to complete interaction with Fourth Partner:'
...
class WaitingPage(WaitPage):
    template_name = 'accom_dynam_four/WaitingPage.html'
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        self.participant.vars['payoff_history'][4] = payment_info

        return payment_info

    def app_after_this_page(self, upcoming_apps):
        return 'accom_dynam_five'
