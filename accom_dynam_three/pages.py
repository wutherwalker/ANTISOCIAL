...
class WaitingPageNewApp(WaitPage):
    template_name = 'accom_dynam_three/WaitingPageNewApp.html'
...
class WaitingPageTimer(WaitPage):
    template_name = 'accom_dynam_three/WaitingPageTimer.html'
...
class AccomDynamPage(Page):
    ...
    timer_text = 'Time left to complete interaction with Third Partner:'
...
class WaitingPage(WaitPage):
    template_name = 'accom_dynam_three/WaitingPage.html'
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        self.participant.vars['payoff_history'][3] = payment_info

        return payment_info

    def app_after_this_page(self, upcoming_apps):
        return 'accom_dynam_four'
