...
class WaitingPageNewApp(WaitPage):
    template_name = 'accom_dynam_five/WaitingPageNewApp.html'
...
class WaitingPageTimer(WaitPage):
    template_name = 'accom_dynam_five/WaitingPageTimer.html'
...
class AccomDynamPage(Page):
    ...
    timer_text = 'Time left to complete interaction with Fifth Partner:'
...
class WaitingPage(WaitPage):
    template_name = 'accom_dynam_five/WaitingPage.html'
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        self.participant.vars['payoff_history'][5] = payment_info
...
class PaymentPage(Page):
    ...
    def vars_for_template(self):
        payment_round = random.choice(list(self.participant.vars['payoff_history'].keys()))
        payment_info = self.participant.vars['payoff_history'][payment_round]

        round_to_interact = {1: "First", 2: "Second", 3: "Third", 4: "Fourth", 5: "Fifth"}

        payment_info['interact_for_payment'] = round_to_interact[payment_round]
